...
$compras10 = $consulta->rotacionproductos();
$fechasc='';
$totalesc='';
while ($regfechac=$compras10->fetch_object()) {
  $fechasc=$fechasc.'"'.$regfechac->fecha.'",';
  $totalesc=$totalesc.$regfechac->indicador/*total*/.',';
}
...
$ventas12 = $consulta->rotacionproductospost();
$fechasv='';
$totalesv='';
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h2><center><b>INDICADOR ROTACIÓN DE PRODUCTOS</b></center></h2>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    POSTTEST - ROTACIÓN DE PRODUCTOS
                                </div>
                                <div class="box-body">
...
var compras = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            label: '# Pretest de productos en los últimos 14 dias',
